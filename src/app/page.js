      ...
      <div className="items-center justify-items-center text-5xl dark:shadow-gray-800 pb-4">
        ...
        {/* grid grid-cols-2 max-w-3/5 place-self-center */}
          ...
          <p className={jetbrains.className}>
            Hi. Welcome to my page. I do a lot of different things. If you're a recruiter, please feel free to take a look at my CS/EE portfolio. If you're here for my art, you can check that out too.
          </p>
          </div>
